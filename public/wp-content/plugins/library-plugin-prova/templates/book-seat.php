...
if(str_contains($_SERVER['REQUEST_URI'], 'edit=true')){
	echo 'ciao mondo';
	$field['id_utente']       = htmlspecialchars( $_GET['id_utente'] );
	$field['nome_utente']     = htmlspecialchars( $_GET['nome_utente'] );
	$field['email_utente']    = htmlspecialchars( $_GET['email_utente'] );
	$field['nome_stanza']     = htmlspecialchars( $_GET['nome_stanza'] );
	$field['giorno']          = htmlspecialchars( $_GET['giorno'] );
	$field['ora_arrivo']      = htmlspecialchars( $_GET['ora_arrivo'] );
	$field['ora_partenza']    = htmlspecialchars( $_GET['ora_partenza'] );
	$field['tutto_il_giorno'] = htmlspecialchars( $_GET['tutto_il_giorno'] );

	if( (str_contains($_SERVER['REQUEST_URI'], 'edit=true') && isset($_POST['update']))){
