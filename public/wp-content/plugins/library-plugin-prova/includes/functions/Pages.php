...
//		$page_summary = 'Riepilogo';
//        $page_logout = 'Logout';
//
//        if (get_page_by_title($page_prenotazione) == NULL && get_page_by_title($page_signup) == NULL && get_page_by_title($page_scegli_posto) == NULL && get_page_by_title($page_booking_successful) == NULL && get_page_by_title($page_logout) == NULL && get_page_by_title($page_summary) == NULL) {
//
//            $prenotazione = [
